...
class ModelosRentaMiCarro{
    ...
    static public function index($tabla){
        $stmt = Conexion::conectar()->prepare("SELECT idRentas, recoDire.Calle AS CalleReco, recoDire.NumExt as NumExtReco, recoColo.coloNombre as ColoniaReco, recoMuni.nombre as MunicipioReco, recoEstado.nombre as EstadoReco, recoCP.CP,
